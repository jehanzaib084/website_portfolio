  ...
  return (
    <div className="relative w-full">
      ...
      <div className="absolute bottom-[-100px] left-1/2 transform -translate-x-1/2 flex items-center gap-4">
        <div
          className="flex h-[60px] w-[60px] cursor-pointer items-center justify-center bg-black border border-white transition-colors duration-300 hover:bg-white hover:text-black"
